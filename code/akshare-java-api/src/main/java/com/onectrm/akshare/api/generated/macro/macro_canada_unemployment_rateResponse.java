    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_canada_unemployment_rateResponse extends AkShareRequestAndResponse {
    public macro_canada_unemployment_rateResponse(){
    setInterfaceName("macro_canada_unemployment_rate");
    }

    public static macro_canada_unemployment_rateResponse of(
    ...
    <String
    , String>... others){
    macro_canada_unemployment_rateResponse t = new macro_canada_unemployment_rateResponse();
