...
* 限量: 单次返回所有历史数据
*/
public class macro_china_hk_gbp_ratioResponse extends AkShareRequestAndResponse {
    public macro_china_hk_gbp_ratioResponse(){
        setInterfaceName("macro_china_hk_gbp_ratio");
    }

    public static macro_china_hk_gbp_ratioResponse of(
    ...
    macro_china_hk_gbp_ratioResponse t = new macro_china_hk_gbp_ratioResponse();
