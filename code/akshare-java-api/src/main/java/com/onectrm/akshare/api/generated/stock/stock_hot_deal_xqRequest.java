    ...
    * 限量: 单次返回所有股票的热度数据
    */
    public class stock_hot_deal_xqRequest extends AkShareRequestAndResponse {
    public stock_hot_deal_xqRequest(){
    setInterfaceName("stock_hot_deal_xq");
    }

    public static stock_hot_deal_xqRequest of(
    ...
    <String
    , String>... others){
    stock_hot_deal_xqRequest t = new stock_hot_deal_xqRequest();
