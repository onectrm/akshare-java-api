    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_canada_core_cpi_yearlyResponse extends AkShareRequestAndResponse {
    public macro_canada_core_cpi_yearlyResponse(){
    setInterfaceName("macro_canada_core_cpi_yearly");
    }

    public static macro_canada_core_cpi_yearlyResponse of(
    ...
    <String
    , String>... others){
    macro_canada_core_cpi_yearlyResponse t = new macro_canada_core_cpi_yearlyResponse();
