    ...
    * 限量: 单次返回当前时刻所有成份股
    */
    public class stock_board_concept_cons_emResponse extends AkShareRequestAndResponse {
    public stock_board_concept_cons_emResponse(){
    setInterfaceName("stock_board_concept_cons_em");
    }

    public static stock_board_concept_cons_emResponse of(
    ...
    <String
    , String>... others){
    stock_board_concept_cons_emResponse t = new stock_board_concept_cons_emResponse();
