...
*/
public class futures_nh_volatility_indexResponse extends AkShareRequestAndResponse {
    public futures_nh_volatility_indexResponse(){
        setInterfaceName("futures_nh_volatility_index");
    }

    public static futures_nh_volatility_indexResponse of(
    ...
    futures_nh_volatility_indexResponse t = new futures_nh_volatility_indexResponse();
