...
* 限量: 单次返回所有历史数据，每日更新
*/
public class covid_19_csse_global_deathResponse extends AkShareRequestAndResponse {
    public covid_19_csse_global_deathResponse(){
        setInterfaceName("covid_19_csse_global_death");
    }

    public static covid_19_csse_global_deathResponse of(
    ...
    covid_19_csse_global_deathResponse t = new covid_19_csse_global_deathResponse();
