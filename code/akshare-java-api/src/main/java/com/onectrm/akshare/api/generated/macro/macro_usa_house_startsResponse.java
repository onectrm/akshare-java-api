    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_house_startsResponse extends AkShareRequestAndResponse {
    public macro_usa_house_startsResponse(){
    setInterfaceName("macro_usa_house_starts");
    }

    public static macro_usa_house_startsResponse of(
    ...
    <String
    , String>... others){
    macro_usa_house_startsResponse t = new macro_usa_house_startsResponse();
