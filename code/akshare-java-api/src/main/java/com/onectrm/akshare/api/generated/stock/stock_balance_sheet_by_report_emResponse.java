    ...
    */
    public class stock_balance_sheet_by_report_emResponse extends AkShareRequestAndResponse {
    public stock_balance_sheet_by_report_emResponse(){
    setInterfaceName("stock_balance_sheet_by_report_em");
    }

    public static stock_balance_sheet_by_report_emResponse of(
    ...
    <String
    , String>... others){
    stock_balance_sheet_by_report_emResponse t = new stock_balance_sheet_by_report_emResponse();
