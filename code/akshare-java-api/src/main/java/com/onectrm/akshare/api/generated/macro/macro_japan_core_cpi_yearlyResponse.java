...
* 限量: 单次返回所有历史数据
*/
public class macro_japan_core_cpi_yearlyResponse extends AkShareRequestAndResponse {
    public macro_japan_core_cpi_yearlyResponse(){
        setInterfaceName("macro_japan_core_cpi_yearly");
    }

    public static macro_japan_core_cpi_yearlyResponse of(
    ...
    macro_japan_core_cpi_yearlyResponse t = new macro_japan_core_cpi_yearlyResponse();
