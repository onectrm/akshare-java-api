    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_lmciResponse extends AkShareRequestAndResponse {
    public macro_usa_lmciResponse(){
    setInterfaceName("macro_usa_lmci");
    }

    public static macro_usa_lmciResponse of(
    ...
    <String
    , String>... others){
    macro_usa_lmciResponse t = new macro_usa_lmciResponse();
