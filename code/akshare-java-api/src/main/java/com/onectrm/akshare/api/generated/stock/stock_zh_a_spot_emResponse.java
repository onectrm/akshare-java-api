    ...
    */
    public class stock_zh_a_spot_emResponse extends AkShareRequestAndResponse {
    public stock_zh_a_spot_emResponse(){
    setInterfaceName("stock_zh_a_spot_em");
    }

    public static stock_zh_a_spot_emResponse of(
    ...
    <String
    , String>... others){
    stock_zh_a_spot_emResponse t = new stock_zh_a_spot_emResponse();
