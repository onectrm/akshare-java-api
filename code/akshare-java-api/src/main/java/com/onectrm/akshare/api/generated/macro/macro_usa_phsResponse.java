...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_phsResponse extends AkShareRequestAndResponse {
    public macro_usa_phsResponse(){
        setInterfaceName("macro_usa_phs");
    }

    public static macro_usa_phsResponse of(
    ...
    macro_usa_phsResponse t = new macro_usa_phsResponse();
