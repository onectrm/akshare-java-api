    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_ppiResponse extends AkShareRequestAndResponse {
    public macro_china_hk_ppiResponse(){
    setInterfaceName("macro_china_hk_ppi");
    }

    public static macro_china_hk_ppiResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_ppiResponse t = new macro_china_hk_ppiResponse();
