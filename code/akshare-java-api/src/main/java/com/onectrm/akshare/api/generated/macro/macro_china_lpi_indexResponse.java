    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_lpi_indexResponse extends AkShareRequestAndResponse {
    public macro_china_lpi_indexResponse(){
    setInterfaceName("macro_china_lpi_index");
    }

    public static macro_china_lpi_indexResponse of(
    ...
    <String
    , String>... others){
    macro_china_lpi_indexResponse t = new macro_china_lpi_indexResponse();
