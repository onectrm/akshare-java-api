...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_building_permitsResponse extends AkShareRequestAndResponse {
    public macro_usa_building_permitsResponse(){
        setInterfaceName("macro_usa_building_permits");
    }

    public static macro_usa_building_permitsResponse of(
    ...
    macro_usa_building_permitsResponse t = new macro_usa_building_permitsResponse();
