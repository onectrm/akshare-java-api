...
* 限量: 单次返回所有历史数据
*/
public class macro_germany_trade_adjustedResponse extends AkShareRequestAndResponse {
    public macro_germany_trade_adjustedResponse(){
        setInterfaceName("macro_germany_trade_adjusted");
    }

    public static macro_germany_trade_adjustedResponse of(
    ...
    macro_germany_trade_adjustedResponse t = new macro_germany_trade_adjustedResponse();
