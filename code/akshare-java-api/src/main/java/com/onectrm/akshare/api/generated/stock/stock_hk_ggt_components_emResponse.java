...
* 限量: 单次获取所有港股通成份股数据
*/
public class stock_hk_ggt_components_emResponse extends AkShareRequestAndResponse {
    public stock_hk_ggt_components_emResponse(){
        setInterfaceName("stock_hk_ggt_components_em");
    }

    public static stock_hk_ggt_components_emResponse of(
    ...
    stock_hk_ggt_components_emResponse t = new stock_hk_ggt_components_emResponse();
