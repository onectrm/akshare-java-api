    ...
    */
    public class stock_zh_a_hist_pre_min_emResponse extends AkShareRequestAndResponse {
    public stock_zh_a_hist_pre_min_emResponse(){
    setInterfaceName("stock_zh_a_hist_pre_min_em");
    }

    public static stock_zh_a_hist_pre_min_emResponse of(
    ...
    <String
    , String>... others){
    stock_zh_a_hist_pre_min_emResponse t = new stock_zh_a_hist_pre_min_emResponse();
