    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_cpi_ratioResponse extends AkShareRequestAndResponse {
    public macro_china_hk_cpi_ratioResponse(){
    setInterfaceName("macro_china_hk_cpi_ratio");
    }

    public static macro_china_hk_cpi_ratioResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_cpi_ratioResponse t = new macro_china_hk_cpi_ratioResponse();
