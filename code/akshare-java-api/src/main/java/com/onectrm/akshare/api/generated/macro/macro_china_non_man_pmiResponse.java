...
* 限量: 单次返回所有历史数据
*/
public class macro_china_non_man_pmiResponse extends AkShareRequestAndResponse {
    public macro_china_non_man_pmiResponse(){
        setInterfaceName("macro_china_non_man_pmi");
    }

    public static macro_china_non_man_pmiResponse of(
    ...
    macro_china_non_man_pmiResponse t = new macro_china_non_man_pmiResponse();
