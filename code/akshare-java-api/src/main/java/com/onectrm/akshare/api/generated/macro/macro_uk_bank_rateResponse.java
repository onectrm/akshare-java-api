...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_bank_rateResponse extends AkShareRequestAndResponse {
    public macro_uk_bank_rateResponse(){
        setInterfaceName("macro_uk_bank_rate");
    }

    public static macro_uk_bank_rateResponse of(
    ...
    macro_uk_bank_rateResponse t = new macro_uk_bank_rateResponse();
