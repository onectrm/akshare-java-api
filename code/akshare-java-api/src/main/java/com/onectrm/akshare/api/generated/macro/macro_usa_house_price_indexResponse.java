...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_house_price_indexResponse extends AkShareRequestAndResponse {
    public macro_usa_house_price_indexResponse(){
        setInterfaceName("macro_usa_house_price_index");
    }

    public static macro_usa_house_price_indexResponse of(
    ...
    macro_usa_house_price_indexResponse t = new macro_usa_house_price_indexResponse();
