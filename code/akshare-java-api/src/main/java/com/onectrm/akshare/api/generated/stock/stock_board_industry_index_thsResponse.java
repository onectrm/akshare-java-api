...
* 限量: 单次返回所有日频指数数据
*/
public class stock_board_industry_index_thsResponse extends AkShareRequestAndResponse {
    public stock_board_industry_index_thsResponse(){
        setInterfaceName("stock_board_industry_index_ths");
    }

    public static stock_board_industry_index_thsResponse of(
    ...
    stock_board_industry_index_thsResponse t = new stock_board_industry_index_thsResponse();
