...
* 限量: 单次返回所有历史数据
*/
public class macro_china_industrial_production_yoyResponse extends AkShareRequestAndResponse {
    public macro_china_industrial_production_yoyResponse(){
        setInterfaceName("macro_china_industrial_production_yoy");
    }

    public static macro_china_industrial_production_yoyResponse of(
    ...
    macro_china_industrial_production_yoyResponse t = new macro_china_industrial_production_yoyResponse();
