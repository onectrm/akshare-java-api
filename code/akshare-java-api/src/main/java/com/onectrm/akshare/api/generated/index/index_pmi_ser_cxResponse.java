...
* 限量: 该接口返回所有历史数据
*/
public class index_pmi_ser_cxResponse extends AkShareRequestAndResponse {
    public index_pmi_ser_cxResponse(){
        setInterfaceName("index_pmi_ser_cx");
    }

    public static index_pmi_ser_cxResponse of(
    ...
    Double p_fu2wu4ye4PMI,


    Map.Entry<String, String>... others){
    index_pmi_ser_cxResponse t = new index_pmi_ser_cxResponse();
    ...
    t.p_fu2wu4ye4PMI = p_fu2wu4ye4PMI;
    ...
    */
    ...
    private Double p_fu2wu4ye4PMI;

    public Double getP_fu2wu4ye4PMI() { return this.p_fu2wu4ye4PMI;}
    public void setP_fu2wu4ye4PMI(Double v) { this.p_fu2wu4ye4PMI = v;}
