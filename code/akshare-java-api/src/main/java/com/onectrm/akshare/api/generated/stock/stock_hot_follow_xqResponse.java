    ...
    * 限量: 单次返回所有股票的热度数据
    */
    public class stock_hot_follow_xqResponse extends AkShareRequestAndResponse {
    public stock_hot_follow_xqResponse(){
    setInterfaceName("stock_hot_follow_xq");
    }

    public static stock_hot_follow_xqResponse of(
    ...
    <String
    , String>... others){
    stock_hot_follow_xqResponse t = new stock_hot_follow_xqResponse();
