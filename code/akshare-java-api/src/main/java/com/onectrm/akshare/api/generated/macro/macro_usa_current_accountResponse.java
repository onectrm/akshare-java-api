    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_current_accountResponse extends AkShareRequestAndResponse {
    public macro_usa_current_accountResponse(){
    setInterfaceName("macro_usa_current_account");
    }

    public static macro_usa_current_accountResponse of(
    ...
    <String
    , String>... others){
    macro_usa_current_accountResponse t = new macro_usa_current_accountResponse();
