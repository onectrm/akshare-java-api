...
* 限量: 单次返回所有历史数据
*/
public class macro_canada_new_house_rateResponse extends AkShareRequestAndResponse {
    public macro_canada_new_house_rateResponse(){
        setInterfaceName("macro_canada_new_house_rate");
    }

    public static macro_canada_new_house_rateResponse of(
    ...
    macro_canada_new_house_rateResponse t = new macro_canada_new_house_rateResponse();
