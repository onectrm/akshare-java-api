...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_durable_goods_ordersResponse extends AkShareRequestAndResponse {
    public macro_usa_durable_goods_ordersResponse(){
        setInterfaceName("macro_usa_durable_goods_orders");
    }

    public static macro_usa_durable_goods_ordersResponse of(
    ...
    macro_usa_durable_goods_ordersResponse t = new macro_usa_durable_goods_ordersResponse();
