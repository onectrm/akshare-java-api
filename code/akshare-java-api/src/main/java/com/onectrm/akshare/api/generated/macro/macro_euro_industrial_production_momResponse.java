...
* 限量: 单次返回所有历史数据
*/
public class macro_euro_industrial_production_momResponse extends AkShareRequestAndResponse {
    public macro_euro_industrial_production_momResponse(){
        setInterfaceName("macro_euro_industrial_production_mom");
    }

    public static macro_euro_industrial_production_momResponse of(
    ...
    macro_euro_industrial_production_momResponse t = new macro_euro_industrial_production_momResponse();
