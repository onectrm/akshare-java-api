    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_building_volumeResponse extends AkShareRequestAndResponse {
    public macro_china_hk_building_volumeResponse(){
    setInterfaceName("macro_china_hk_building_volume");
    }

    public static macro_china_hk_building_volumeResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_building_volumeResponse t = new macro_china_hk_building_volumeResponse();
