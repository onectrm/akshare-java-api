    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_cpiResponse extends AkShareRequestAndResponse {
    public macro_china_hk_cpiResponse(){
    setInterfaceName("macro_china_hk_cpi");
    }

    public static macro_china_hk_cpiResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_cpiResponse t = new macro_china_hk_cpiResponse();
