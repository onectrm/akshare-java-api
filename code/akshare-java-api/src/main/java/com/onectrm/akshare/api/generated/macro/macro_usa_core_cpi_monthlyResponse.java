    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_core_cpi_monthlyResponse extends AkShareRequestAndResponse {
    public macro_usa_core_cpi_monthlyResponse(){
    setInterfaceName("macro_usa_core_cpi_monthly");
    }

    public static macro_usa_core_cpi_monthlyResponse of(
    ...
    <String
    , String>... others){
    macro_usa_core_cpi_monthlyResponse t = new macro_usa_core_cpi_monthlyResponse();
