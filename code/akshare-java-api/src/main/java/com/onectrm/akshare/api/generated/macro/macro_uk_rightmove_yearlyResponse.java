...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_rightmove_yearlyResponse extends AkShareRequestAndResponse {
    public macro_uk_rightmove_yearlyResponse(){
        setInterfaceName("macro_uk_rightmove_yearly");
    }

    public static macro_uk_rightmove_yearlyResponse of(
    ...
    macro_uk_rightmove_yearlyResponse t = new macro_uk_rightmove_yearlyResponse();
