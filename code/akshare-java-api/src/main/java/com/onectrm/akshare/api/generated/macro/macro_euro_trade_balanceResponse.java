    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_euro_trade_balanceResponse extends AkShareRequestAndResponse {
    public macro_euro_trade_balanceResponse(){
    setInterfaceName("macro_euro_trade_balance");
    }

    public static macro_euro_trade_balanceResponse of(
    ...
    <String
    , String>... others){
    macro_euro_trade_balanceResponse t = new macro_euro_trade_balanceResponse();
