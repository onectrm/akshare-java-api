    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_japan_head_indicatorResponse extends AkShareRequestAndResponse {
    public macro_japan_head_indicatorResponse(){
    setInterfaceName("macro_japan_head_indicator");
    }

    public static macro_japan_head_indicatorResponse of(
    ...
    <String
    , String>... others){
    macro_japan_head_indicatorResponse t = new macro_japan_head_indicatorResponse();
