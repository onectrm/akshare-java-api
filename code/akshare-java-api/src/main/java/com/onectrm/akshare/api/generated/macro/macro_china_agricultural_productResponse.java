    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_agricultural_productResponse extends AkShareRequestAndResponse {
    public macro_china_agricultural_productResponse(){
    setInterfaceName("macro_china_agricultural_product");
    }

    public static macro_china_agricultural_productResponse of(
    ...
    <String
    , String>... others){
    macro_china_agricultural_productResponse t = new macro_china_agricultural_productResponse();
