    ...
    * 限量: 单次返回所有数据
    */
    public class stock_rank_xxtp_thsResponse extends AkShareRequestAndResponse {
    public stock_rank_xxtp_thsResponse(){
    setInterfaceName("stock_rank_xxtp_ths");
    }

    public static stock_rank_xxtp_thsResponse of(
    ...
    <String
    , String>... others){
    stock_rank_xxtp_thsResponse t = new stock_rank_xxtp_thsResponse();
