...
*/
public class stock_us_zh_spotResponse extends AkShareRequestAndResponse {
    public stock_us_zh_spotResponse(){
        setInterfaceName("stock_us_zh_spot");
    }

    public static stock_us_zh_spotResponse of(
    ...
    stock_us_zh_spotResponse t = new stock_us_zh_spotResponse();
