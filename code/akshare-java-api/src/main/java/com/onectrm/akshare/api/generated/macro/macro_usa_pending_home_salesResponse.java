    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_pending_home_salesResponse extends AkShareRequestAndResponse {
    public macro_usa_pending_home_salesResponse(){
    setInterfaceName("macro_usa_pending_home_sales");
    }

    public static macro_usa_pending_home_salesResponse of(
    ...
    <String
    , String>... others){
    macro_usa_pending_home_salesResponse t = new macro_usa_pending_home_salesResponse();
