    ...
    * 限量: 
    */
    public class hf_sp_500Response extends AkShareRequestAndResponse {
    public hf_sp_500Response(){
    setInterfaceName("hf_sp_500");
    }

    public static hf_sp_500Response of(
    ...
    <String
    , String>... others){
    hf_sp_500Response t = new hf_sp_500Response();
