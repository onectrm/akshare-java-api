    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_ism_non_pmiResponse extends AkShareRequestAndResponse {
    public macro_usa_ism_non_pmiResponse(){
    setInterfaceName("macro_usa_ism_non_pmi");
    }

    public static macro_usa_ism_non_pmiResponse of(
    ...
    <String
    , String>... others){
    macro_usa_ism_non_pmiResponse t = new macro_usa_ism_non_pmiResponse();
