...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_cftc_c_holdingResponse extends AkShareRequestAndResponse {
    public macro_usa_cftc_c_holdingResponse(){
        setInterfaceName("macro_usa_cftc_c_holding");
    }

    public static macro_usa_cftc_c_holdingResponse of(
    ...
    macro_usa_cftc_c_holdingResponse t = new macro_usa_cftc_c_holdingResponse();
