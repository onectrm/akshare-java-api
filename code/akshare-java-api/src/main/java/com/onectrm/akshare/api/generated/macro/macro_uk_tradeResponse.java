...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_tradeResponse extends AkShareRequestAndResponse {
    public macro_uk_tradeResponse(){
        setInterfaceName("macro_uk_trade");
    }

    public static macro_uk_tradeResponse of(
    ...
    macro_uk_tradeResponse t = new macro_uk_tradeResponse();
