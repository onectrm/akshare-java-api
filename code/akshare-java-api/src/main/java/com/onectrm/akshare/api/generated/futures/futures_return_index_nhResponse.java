    ...
    * 限量: 单次返回单个指数的所有历史数据
    */
    public class futures_return_index_nhResponse extends AkShareRequestAndResponse {
    public futures_return_index_nhResponse(){
    setInterfaceName("futures_return_index_nh");
    }

    public static futures_return_index_nhResponse of(
    ...
    <String
    , String>... others){
    futures_return_index_nhResponse t = new futures_return_index_nhResponse();
