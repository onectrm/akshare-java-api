    ...
    * 限量: 该接口返回所有历史数据
    */
    public class index_si_cxResponse extends AkShareRequestAndResponse {
    public index_si_cxResponse(){
    setInterfaceName("index_si_cx");
    }

    public static index_si_cxResponse of(


    LocalDate p_ri4qi1,

    Double p_yi4chu1zhi3shu4,
    ...
    <String
    , String>... others){
    index_si_cxResponse t = new index_si_cxResponse();


    t.p_ri4qi1 = p_ri4qi1;

    t.p_yi4chu1zhi3shu4 = p_yi4chu1zhi3shu4;
    ...
    */
    ...
    private Double p_yi4chu1zhi3shu4;

    public Double getP_yi4chu1zhi3shu4() { return this.p_yi4chu1zhi3shu4;}
    public void setP_yi4chu1zhi3shu4(Double v) { this.p_yi4chu1zhi3shu4 = v;}
