...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_rightmove_monthlyResponse extends AkShareRequestAndResponse {
    public macro_uk_rightmove_monthlyResponse(){
        setInterfaceName("macro_uk_rightmove_monthly");
    }

    public static macro_uk_rightmove_monthlyResponse of(
    ...
    macro_uk_rightmove_monthlyResponse t = new macro_uk_rightmove_monthlyResponse();
