...
* 限量: 单次返回所有历史数据
*/
public class macro_euro_sentix_investor_confidenceResponse extends AkShareRequestAndResponse {
    public macro_euro_sentix_investor_confidenceResponse(){
        setInterfaceName("macro_euro_sentix_investor_confidence");
    }

    public static macro_euro_sentix_investor_confidenceResponse of(
    ...
    macro_euro_sentix_investor_confidenceResponse t = new macro_euro_sentix_investor_confidenceResponse();
