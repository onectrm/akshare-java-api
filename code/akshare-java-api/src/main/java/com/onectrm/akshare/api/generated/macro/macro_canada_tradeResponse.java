...
* 限量: 单次返回所有历史数据
*/
public class macro_canada_tradeResponse extends AkShareRequestAndResponse {
    public macro_canada_tradeResponse(){
        setInterfaceName("macro_canada_trade");
    }

    public static macro_canada_tradeResponse of(
    ...
    macro_canada_tradeResponse t = new macro_canada_tradeResponse();
