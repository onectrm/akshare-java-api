...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_real_consumer_spendingResponse extends AkShareRequestAndResponse {
    public macro_usa_real_consumer_spendingResponse(){
        setInterfaceName("macro_usa_real_consumer_spending");
    }

    public static macro_usa_real_consumer_spendingResponse of(
    ...
    macro_usa_real_consumer_spendingResponse t = new macro_usa_real_consumer_spendingResponse();
