...
* 限量: 单次返回所有历史数据
*/
public class macro_euro_services_pmiResponse extends AkShareRequestAndResponse {
    public macro_euro_services_pmiResponse(){
        setInterfaceName("macro_euro_services_pmi");
    }

    public static macro_euro_services_pmiResponse of(
    ...
    macro_euro_services_pmiResponse t = new macro_euro_services_pmiResponse();
