    ...
    */
    public class stock_gdfx_holding_detail_emRequest extends AkShareRequestAndResponse {
    public stock_gdfx_holding_detail_emRequest(){
    setInterfaceName("stock_gdfx_holding_detail_em");
    }

    public static stock_gdfx_holding_detail_emRequest of(
    ...
    <String
    , String>... others){
    stock_gdfx_holding_detail_emRequest t = new stock_gdfx_holding_detail_emRequest();
