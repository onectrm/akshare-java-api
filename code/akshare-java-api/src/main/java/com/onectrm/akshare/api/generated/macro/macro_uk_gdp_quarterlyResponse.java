...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_gdp_quarterlyResponse extends AkShareRequestAndResponse {
    public macro_uk_gdp_quarterlyResponse(){
        setInterfaceName("macro_uk_gdp_quarterly");
    }

    public static macro_uk_gdp_quarterlyResponse of(
    ...
    macro_uk_gdp_quarterlyResponse t = new macro_uk_gdp_quarterlyResponse();
