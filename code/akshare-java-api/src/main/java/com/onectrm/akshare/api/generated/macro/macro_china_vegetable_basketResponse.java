    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_vegetable_basketResponse extends AkShareRequestAndResponse {
    public macro_china_vegetable_basketResponse(){
    setInterfaceName("macro_china_vegetable_basket");
    }

    public static macro_china_vegetable_basketResponse of(
    ...
    <String
    , String>... others){
    macro_china_vegetable_basketResponse t = new macro_china_vegetable_basketResponse();
