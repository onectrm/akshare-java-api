    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_cons_gold_volumeResponse extends AkShareRequestAndResponse {
    public macro_cons_gold_volumeResponse(){
    setInterfaceName("macro_cons_gold_volume");
    }

    public static macro_cons_gold_volumeResponse of(
    ...
    <String
    , String>... others){
    macro_cons_gold_volumeResponse t = new macro_cons_gold_volumeResponse();
