...
*/
public class stock_lrb_emRequest extends AkShareRequestAndResponse {
    public stock_lrb_emRequest(){
        setInterfaceName("stock_lrb_em");
    }

    public static stock_lrb_emRequest of(
    ...
    stock_lrb_emRequest t = new stock_lrb_emRequest();
