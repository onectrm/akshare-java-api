...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_spcs20Response extends AkShareRequestAndResponse {
    public macro_usa_spcs20Response(){
        setInterfaceName("macro_usa_spcs20");
    }

    public static macro_usa_spcs20Response of(
    ...
    macro_usa_spcs20Response t = new macro_usa_spcs20Response();
