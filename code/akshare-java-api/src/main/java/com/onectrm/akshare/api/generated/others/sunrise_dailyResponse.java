    ...
    * 限量: 单次返回指定日期和指定城市的数据
    */
    public class sunrise_dailyResponse extends AkShareRequestAndResponse {
    public sunrise_dailyResponse(){
    setInterfaceName("sunrise_daily");
    }

    public static sunrise_dailyResponse of(
    ...
    <String
    , String>... others){
    sunrise_dailyResponse t = new sunrise_dailyResponse();
