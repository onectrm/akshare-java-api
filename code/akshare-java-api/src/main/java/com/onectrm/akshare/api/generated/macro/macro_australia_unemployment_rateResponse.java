...
* 限量: 单次返回所有历史数据
*/
public class macro_australia_unemployment_rateResponse extends AkShareRequestAndResponse {
    public macro_australia_unemployment_rateResponse(){
        setInterfaceName("macro_australia_unemployment_rate");
    }

    public static macro_australia_unemployment_rateResponse of(
    ...
    macro_australia_unemployment_rateResponse t = new macro_australia_unemployment_rateResponse();
