    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_industrial_productionResponse extends AkShareRequestAndResponse {
    public macro_usa_industrial_productionResponse(){
    setInterfaceName("macro_usa_industrial_production");
    }

    public static macro_usa_industrial_productionResponse of(
    ...
    <String
    , String>... others){
    macro_usa_industrial_productionResponse t = new macro_usa_industrial_productionResponse();
