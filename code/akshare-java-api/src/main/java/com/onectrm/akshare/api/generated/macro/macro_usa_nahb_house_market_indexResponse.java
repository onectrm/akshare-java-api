...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_nahb_house_market_indexResponse extends AkShareRequestAndResponse {
    public macro_usa_nahb_house_market_indexResponse(){
        setInterfaceName("macro_usa_nahb_house_market_index");
    }

    public static macro_usa_nahb_house_market_indexResponse of(
    ...
    macro_usa_nahb_house_market_indexResponse t = new macro_usa_nahb_house_market_indexResponse();
