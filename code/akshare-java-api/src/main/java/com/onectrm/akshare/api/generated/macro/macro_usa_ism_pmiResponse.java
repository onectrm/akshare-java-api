    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_ism_pmiResponse extends AkShareRequestAndResponse {
    public macro_usa_ism_pmiResponse(){
    setInterfaceName("macro_usa_ism_pmi");
    }

    public static macro_usa_ism_pmiResponse of(
    ...
    <String
    , String>... others){
    macro_usa_ism_pmiResponse t = new macro_usa_ism_pmiResponse();
