    ...
    */
    public class currency_latestResponse extends AkShareRequestAndResponse {
    public currency_latestResponse(){
    setInterfaceName("currency_latest");
    }

    public static currency_latestResponse of(
    ...
    <String
    , String>... others){
    currency_latestResponse t = new currency_latestResponse();
