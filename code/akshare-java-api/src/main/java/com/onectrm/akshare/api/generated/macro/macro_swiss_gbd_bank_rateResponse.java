    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_swiss_gbd_bank_rateResponse extends AkShareRequestAndResponse {
    public macro_swiss_gbd_bank_rateResponse(){
    setInterfaceName("macro_swiss_gbd_bank_rate");
    }

    public static macro_swiss_gbd_bank_rateResponse of(
    ...
    <String
    , String>... others){
    macro_swiss_gbd_bank_rateResponse t = new macro_swiss_gbd_bank_rateResponse();
