    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_export_priceResponse extends AkShareRequestAndResponse {
    public macro_usa_export_priceResponse(){
    setInterfaceName("macro_usa_export_price");
    }

    public static macro_usa_export_priceResponse of(
    ...
    <String
    , String>... others){
    macro_usa_export_priceResponse t = new macro_usa_export_priceResponse();
