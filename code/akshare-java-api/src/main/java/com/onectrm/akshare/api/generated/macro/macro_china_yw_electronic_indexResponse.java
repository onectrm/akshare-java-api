...
* 限量: 单次返回所有历史数据
*/
public class macro_china_yw_electronic_indexResponse extends AkShareRequestAndResponse {
    public macro_china_yw_electronic_indexResponse(){
        setInterfaceName("macro_china_yw_electronic_index");
    }

    public static macro_china_yw_electronic_indexResponse of(
    ...
    macro_china_yw_electronic_indexResponse t = new macro_china_yw_electronic_indexResponse();
