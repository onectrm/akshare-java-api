    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_germany_zewResponse extends AkShareRequestAndResponse {
    public macro_germany_zewResponse(){
    setInterfaceName("macro_germany_zew");
    }

    public static macro_germany_zewResponse of(
    ...
    <String
    , String>... others){
    macro_germany_zewResponse t = new macro_germany_zewResponse();
