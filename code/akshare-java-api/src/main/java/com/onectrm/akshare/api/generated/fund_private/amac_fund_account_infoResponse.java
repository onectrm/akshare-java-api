...
* 限量: 单次返回当前时刻所有历史数据
*/
public class amac_fund_account_infoResponse extends AkShareRequestAndResponse {
    public amac_fund_account_infoResponse(){
        setInterfaceName("amac_fund_account_info");
    }

    public static amac_fund_account_infoResponse of(
    ...
    amac_fund_account_infoResponse t = new amac_fund_account_infoResponse();
