    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_initial_joblessResponse extends AkShareRequestAndResponse {
    public macro_usa_initial_joblessResponse(){
    setInterfaceName("macro_usa_initial_jobless");
    }

    public static macro_usa_initial_joblessResponse of(
    ...
    <String
    , String>... others){
    macro_usa_initial_joblessResponse t = new macro_usa_initial_joblessResponse();
