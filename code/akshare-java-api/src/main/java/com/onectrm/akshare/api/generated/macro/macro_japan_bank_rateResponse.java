...
* 限量: 单次返回所有历史数据
*/
public class macro_japan_bank_rateResponse extends AkShareRequestAndResponse {
    public macro_japan_bank_rateResponse(){
        setInterfaceName("macro_japan_bank_rate");
    }

    public static macro_japan_bank_rateResponse of(
    ...
    macro_japan_bank_rateResponse t = new macro_japan_bank_rateResponse();
