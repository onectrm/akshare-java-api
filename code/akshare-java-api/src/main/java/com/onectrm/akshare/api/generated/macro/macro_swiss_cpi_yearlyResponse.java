...
* 限量: 单次返回所有历史数据
*/
public class macro_swiss_cpi_yearlyResponse extends AkShareRequestAndResponse {
    public macro_swiss_cpi_yearlyResponse(){
        setInterfaceName("macro_swiss_cpi_yearly");
    }

    public static macro_swiss_cpi_yearlyResponse of(
    ...
    macro_swiss_cpi_yearlyResponse t = new macro_swiss_cpi_yearlyResponse();
