    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_imports_yoyResponse extends AkShareRequestAndResponse {
    public macro_china_imports_yoyResponse(){
    setInterfaceName("macro_china_imports_yoy");
    }

    public static macro_china_imports_yoyResponse of(
    ...
    <String
    , String>... others){
    macro_china_imports_yoyResponse t = new macro_china_imports_yoyResponse();
