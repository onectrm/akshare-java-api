...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_cpi_monthlyResponse extends AkShareRequestAndResponse {
    public macro_uk_cpi_monthlyResponse(){
        setInterfaceName("macro_uk_cpi_monthly");
    }

    public static macro_uk_cpi_monthlyResponse of(
    ...
    macro_uk_cpi_monthlyResponse t = new macro_uk_cpi_monthlyResponse();
