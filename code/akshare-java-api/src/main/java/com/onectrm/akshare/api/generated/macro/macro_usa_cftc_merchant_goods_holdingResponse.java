...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_cftc_merchant_goods_holdingResponse extends AkShareRequestAndResponse {
    public macro_usa_cftc_merchant_goods_holdingResponse(){
        setInterfaceName("macro_usa_cftc_merchant_goods_holding");
    }

    public static macro_usa_cftc_merchant_goods_holdingResponse of(
    ...
    macro_usa_cftc_merchant_goods_holdingResponse t = new macro_usa_cftc_merchant_goods_holdingResponse();
