...
*/
public class currency_time_seriesResponse extends AkShareRequestAndResponse {
    public currency_time_seriesResponse(){
        setInterfaceName("currency_time_series");
    }

    public static currency_time_seriesResponse of(
    ...
    currency_time_seriesResponse t = new currency_time_seriesResponse();
