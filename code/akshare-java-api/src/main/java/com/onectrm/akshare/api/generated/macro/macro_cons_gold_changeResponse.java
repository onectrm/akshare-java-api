...
* 限量: 单次返回所有历史数据
*/
public class macro_cons_gold_changeResponse extends AkShareRequestAndResponse {
    public macro_cons_gold_changeResponse(){
        setInterfaceName("macro_cons_gold_change");
    }

    public static macro_cons_gold_changeResponse of(
    ...
    macro_cons_gold_changeResponse t = new macro_cons_gold_changeResponse();
