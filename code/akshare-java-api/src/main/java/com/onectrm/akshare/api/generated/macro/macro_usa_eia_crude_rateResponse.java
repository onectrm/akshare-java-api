...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_eia_crude_rateResponse extends AkShareRequestAndResponse {
    public macro_usa_eia_crude_rateResponse(){
        setInterfaceName("macro_usa_eia_crude_rate");
    }

    public static macro_usa_eia_crude_rateResponse of(
    ...
    macro_usa_eia_crude_rateResponse t = new macro_usa_eia_crude_rateResponse();
