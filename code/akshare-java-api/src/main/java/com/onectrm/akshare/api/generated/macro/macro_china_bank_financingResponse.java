    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_bank_financingResponse extends AkShareRequestAndResponse {
    public macro_china_bank_financingResponse(){
    setInterfaceName("macro_china_bank_financing");
    }

    public static macro_china_bank_financingResponse of(
    ...
    <String
    , String>... others){
    macro_china_bank_financingResponse t = new macro_china_bank_financingResponse();
