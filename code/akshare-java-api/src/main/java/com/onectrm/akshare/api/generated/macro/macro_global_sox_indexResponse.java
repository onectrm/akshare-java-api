    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_global_sox_indexResponse extends AkShareRequestAndResponse {
    public macro_global_sox_indexResponse(){
    setInterfaceName("macro_global_sox_index");
    }

    public static macro_global_sox_indexResponse of(
    ...
    <String
    , String>... others){
    macro_global_sox_indexResponse t = new macro_global_sox_indexResponse();
