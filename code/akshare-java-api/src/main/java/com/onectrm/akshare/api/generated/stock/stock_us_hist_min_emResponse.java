    ...
    */
    public class stock_us_hist_min_emResponse extends AkShareRequestAndResponse {
    public stock_us_hist_min_emResponse(){
    setInterfaceName("stock_us_hist_min_em");
    }

    public static stock_us_hist_min_emResponse of(
    ...
    <String
    , String>... others){
    stock_us_hist_min_emResponse t = new stock_us_hist_min_emResponse();
