    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_factory_ordersResponse extends AkShareRequestAndResponse {
    public macro_usa_factory_ordersResponse(){
    setInterfaceName("macro_usa_factory_orders");
    }

    public static macro_usa_factory_ordersResponse of(
    ...
    <String
    , String>... others){
    macro_usa_factory_ordersResponse t = new macro_usa_factory_ordersResponse();
