...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_job_cutsResponse extends AkShareRequestAndResponse {
    public macro_usa_job_cutsResponse(){
        setInterfaceName("macro_usa_job_cuts");
    }

    public static macro_usa_job_cutsResponse of(
    ...
    macro_usa_job_cutsResponse t = new macro_usa_job_cutsResponse();
