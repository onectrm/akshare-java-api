    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_fx_reserves_yearlyResponse extends AkShareRequestAndResponse {
    public macro_china_fx_reserves_yearlyResponse(){
    setInterfaceName("macro_china_fx_reserves_yearly");
    }

    public static macro_china_fx_reserves_yearlyResponse of(
    ...
    <String
    , String>... others){
    macro_china_fx_reserves_yearlyResponse t = new macro_china_fx_reserves_yearlyResponse();
