...
* 限量: 单次返回所有历史数据
*/
public class macro_china_hk_rate_of_unemploymentResponse extends AkShareRequestAndResponse {
    public macro_china_hk_rate_of_unemploymentResponse(){
        setInterfaceName("macro_china_hk_rate_of_unemployment");
    }

    public static macro_china_hk_rate_of_unemploymentResponse of(
    ...
    macro_china_hk_rate_of_unemploymentResponse t = new macro_china_hk_rate_of_unemploymentResponse();
