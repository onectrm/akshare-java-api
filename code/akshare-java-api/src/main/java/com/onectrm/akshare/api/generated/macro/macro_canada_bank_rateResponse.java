...
* 限量: 单次返回所有历史数据
*/
public class macro_canada_bank_rateResponse extends AkShareRequestAndResponse {
    public macro_canada_bank_rateResponse(){
        setInterfaceName("macro_canada_bank_rate");
    }

    public static macro_canada_bank_rateResponse of(
    ...
    macro_canada_bank_rateResponse t = new macro_canada_bank_rateResponse();
