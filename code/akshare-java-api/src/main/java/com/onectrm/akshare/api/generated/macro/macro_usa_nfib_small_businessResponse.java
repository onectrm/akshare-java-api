    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_nfib_small_businessResponse extends AkShareRequestAndResponse {
    public macro_usa_nfib_small_businessResponse(){
    setInterfaceName("macro_usa_nfib_small_business");
    }

    public static macro_usa_nfib_small_businessResponse of(
    ...
    <String
    , String>... others){
    macro_usa_nfib_small_businessResponse t = new macro_usa_nfib_small_businessResponse();
