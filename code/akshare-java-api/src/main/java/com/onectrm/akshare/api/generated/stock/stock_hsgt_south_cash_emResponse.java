    ...
    */
    public class stock_hsgt_south_cash_emResponse extends AkShareRequestAndResponse {
    public stock_hsgt_south_cash_emResponse(){
    setInterfaceName("stock_hsgt_south_cash_em");
    }

    public static stock_hsgt_south_cash_emResponse of(
    ...
    <String
    , String>... others){
    stock_hsgt_south_cash_emResponse t = new stock_hsgt_south_cash_emResponse();
