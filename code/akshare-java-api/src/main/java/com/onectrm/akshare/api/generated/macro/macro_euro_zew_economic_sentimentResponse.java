    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_euro_zew_economic_sentimentResponse extends AkShareRequestAndResponse {
    public macro_euro_zew_economic_sentimentResponse(){
    setInterfaceName("macro_euro_zew_economic_sentiment");
    }

    public static macro_euro_zew_economic_sentimentResponse of(
    ...
    <String
    , String>... others){
    macro_euro_zew_economic_sentimentResponse t = new macro_euro_zew_economic_sentimentResponse();
