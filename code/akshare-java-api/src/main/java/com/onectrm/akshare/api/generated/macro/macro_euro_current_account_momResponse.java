...
* 限量: 单次返回所有历史数据
*/
public class macro_euro_current_account_momResponse extends AkShareRequestAndResponse {
    public macro_euro_current_account_momResponse(){
        setInterfaceName("macro_euro_current_account_mom");
    }

    public static macro_euro_current_account_momResponse of(
    ...
    macro_euro_current_account_momResponse t = new macro_euro_current_account_momResponse();
