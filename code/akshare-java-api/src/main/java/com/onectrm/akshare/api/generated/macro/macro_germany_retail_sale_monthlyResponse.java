    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_germany_retail_sale_monthlyResponse extends AkShareRequestAndResponse {
    public macro_germany_retail_sale_monthlyResponse(){
    setInterfaceName("macro_germany_retail_sale_monthly");
    }

    public static macro_germany_retail_sale_monthlyResponse of(
    ...
    <String
    , String>... others){
    macro_germany_retail_sale_monthlyResponse t = new macro_germany_retail_sale_monthlyResponse();
