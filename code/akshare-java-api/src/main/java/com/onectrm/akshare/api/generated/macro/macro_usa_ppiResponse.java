    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_ppiResponse extends AkShareRequestAndResponse {
    public macro_usa_ppiResponse(){
    setInterfaceName("macro_usa_ppi");
    }

    public static macro_usa_ppiResponse of(
    ...
    <String
    , String>... others){
    macro_usa_ppiResponse t = new macro_usa_ppiResponse();
