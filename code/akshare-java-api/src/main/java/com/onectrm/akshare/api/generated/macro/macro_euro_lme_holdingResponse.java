...
* 限量: 单次返回所有历史数据
*/
public class macro_euro_lme_holdingResponse extends AkShareRequestAndResponse {
    public macro_euro_lme_holdingResponse(){
        setInterfaceName("macro_euro_lme_holding");
    }

    public static macro_euro_lme_holdingResponse of(
    ...
    macro_euro_lme_holdingResponse t = new macro_euro_lme_holdingResponse();
