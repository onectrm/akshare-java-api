    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_euro_gdp_yoyResponse extends AkShareRequestAndResponse {
    public macro_euro_gdp_yoyResponse(){
    setInterfaceName("macro_euro_gdp_yoy");
    }

    public static macro_euro_gdp_yoyResponse of(
    ...
    <String
    , String>... others){
    macro_euro_gdp_yoyResponse t = new macro_euro_gdp_yoyResponse();
