    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_australia_cpi_quarterlyResponse extends AkShareRequestAndResponse {
    public macro_australia_cpi_quarterlyResponse(){
    setInterfaceName("macro_australia_cpi_quarterly");
    }

    public static macro_australia_cpi_quarterlyResponse of(
    ...
    <String
    , String>... others){
    macro_australia_cpi_quarterlyResponse t = new macro_australia_cpi_quarterlyResponse();
