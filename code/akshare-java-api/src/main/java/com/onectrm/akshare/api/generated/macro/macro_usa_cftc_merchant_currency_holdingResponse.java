...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_cftc_merchant_currency_holdingResponse extends AkShareRequestAndResponse {
    public macro_usa_cftc_merchant_currency_holdingResponse(){
        setInterfaceName("macro_usa_cftc_merchant_currency_holding");
    }

    public static macro_usa_cftc_merchant_currency_holdingResponse of(
    ...
    macro_usa_cftc_merchant_currency_holdingResponse t = new macro_usa_cftc_merchant_currency_holdingResponse();
