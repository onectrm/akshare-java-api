    ...
    */
    public class stock_hk_hist_min_emResponse extends AkShareRequestAndResponse {
    public stock_hk_hist_min_emResponse(){
    setInterfaceName("stock_hk_hist_min_em");
    }

    public static stock_hk_hist_min_emResponse of(
    ...
    <String
    , String>... others){
    stock_hk_hist_min_emResponse t = new stock_hk_hist_min_emResponse();
