...
* 限量: 单次返回所有历史数据
*/
public class macro_china_commodity_price_indexResponse extends AkShareRequestAndResponse {
    public macro_china_commodity_price_indexResponse(){
        setInterfaceName("macro_china_commodity_price_index");
    }

    public static macro_china_commodity_price_indexResponse of(
    ...
    macro_china_commodity_price_indexResponse t = new macro_china_commodity_price_indexResponse();
