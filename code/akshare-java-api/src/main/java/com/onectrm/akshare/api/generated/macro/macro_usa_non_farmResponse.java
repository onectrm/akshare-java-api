    ...
    * 限量: 单次返回某一个所有历史数据
    */
    public class macro_usa_non_farmResponse extends AkShareRequestAndResponse {
    public macro_usa_non_farmResponse(){
    setInterfaceName("macro_usa_non_farm");
    }

    public static macro_usa_non_farmResponse of(
    ...
    <String
    , String>... others){
    macro_usa_non_farmResponse t = new macro_usa_non_farmResponse();
