...
*/
public class stock_xjll_emRequest extends AkShareRequestAndResponse {
    public stock_xjll_emRequest(){
        setInterfaceName("stock_xjll_em");
    }

    public static stock_xjll_emRequest of(
    ...
    stock_xjll_emRequest t = new stock_xjll_emRequest();
