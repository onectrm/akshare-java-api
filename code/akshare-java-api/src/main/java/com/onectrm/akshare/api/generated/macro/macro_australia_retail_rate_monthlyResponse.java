    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_australia_retail_rate_monthlyResponse extends AkShareRequestAndResponse {
    public macro_australia_retail_rate_monthlyResponse(){
    setInterfaceName("macro_australia_retail_rate_monthly");
    }

    public static macro_australia_retail_rate_monthlyResponse of(
    ...
    <String
    , String>... others){
    macro_australia_retail_rate_monthlyResponse t = new macro_australia_retail_rate_monthlyResponse();
