...
* 限量: 单次返回所有历史数据
*/
public class macro_usa_unemployment_rateResponse extends AkShareRequestAndResponse {
    public macro_usa_unemployment_rateResponse(){
        setInterfaceName("macro_usa_unemployment_rate");
    }

    public static macro_usa_unemployment_rateResponse of(
    ...
    macro_usa_unemployment_rateResponse t = new macro_usa_unemployment_rateResponse();
