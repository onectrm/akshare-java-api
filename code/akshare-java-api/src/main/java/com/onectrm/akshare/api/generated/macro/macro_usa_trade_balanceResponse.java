    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_usa_trade_balanceResponse extends AkShareRequestAndResponse {
    public macro_usa_trade_balanceResponse(){
    setInterfaceName("macro_usa_trade_balance");
    }

    public static macro_usa_trade_balanceResponse of(
    ...
    <String
    , String>... others){
    macro_usa_trade_balanceResponse t = new macro_usa_trade_balanceResponse();
