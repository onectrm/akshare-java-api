    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_gbpResponse extends AkShareRequestAndResponse {
    public macro_china_hk_gbpResponse(){
    setInterfaceName("macro_china_hk_gbp");
    }

    public static macro_china_hk_gbpResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_gbpResponse t = new macro_china_hk_gbpResponse();
