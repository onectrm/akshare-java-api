...
* 限量: 单次返回所有数据
*/
public class stock_rank_xstp_thsResponse extends AkShareRequestAndResponse {
    public stock_rank_xstp_thsResponse(){
        setInterfaceName("stock_rank_xstp_ths");
    }

    public static stock_rank_xstp_thsResponse of(
    ...
    stock_rank_xstp_thsResponse t = new stock_rank_xstp_thsResponse();
