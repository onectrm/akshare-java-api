...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_cpi_yearlyResponse extends AkShareRequestAndResponse {
    public macro_uk_cpi_yearlyResponse(){
        setInterfaceName("macro_uk_cpi_yearly");
    }

    public static macro_uk_cpi_yearlyResponse of(
    ...
    macro_uk_cpi_yearlyResponse t = new macro_uk_cpi_yearlyResponse();
