    ...
    */
    public class stock_zh_a_st_emResponse extends AkShareRequestAndResponse {
    public stock_zh_a_st_emResponse(){
    setInterfaceName("stock_zh_a_st_em");
    }

    public static stock_zh_a_st_emResponse of(
    ...
    <String
    , String>... others){
    stock_zh_a_st_emResponse t = new stock_zh_a_st_emResponse();
