    ...
    * 限量: 单次返回所有历史数据，每日更新
    */
    public class covid_19_csse_us_deathRequest extends AkShareRequestAndResponse {
    public covid_19_csse_us_deathRequest(){
    setInterfaceName("covid_19_csse_us_death");
    }

    public static covid_19_csse_us_deathRequest of(
    ...
    <String
    , String>... others){
    covid_19_csse_us_deathRequest t = new covid_19_csse_us_deathRequest();
