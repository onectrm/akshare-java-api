    ...
    */
    public class stock_board_concept_hist_min_emResponse extends AkShareRequestAndResponse {
    public stock_board_concept_hist_min_emResponse(){
    setInterfaceName("stock_board_concept_hist_min_em");
    }

    public static stock_board_concept_hist_min_emResponse of(
    ...
    <String
    , String>... others){
    stock_board_concept_hist_min_emResponse t = new stock_board_concept_hist_min_emResponse();
