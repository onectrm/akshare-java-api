    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_uk_retail_yearlyResponse extends AkShareRequestAndResponse {
    public macro_uk_retail_yearlyResponse(){
    setInterfaceName("macro_uk_retail_yearly");
    }

    public static macro_uk_retail_yearlyResponse of(
    ...
    <String
    , String>... others){
    macro_uk_retail_yearlyResponse t = new macro_uk_retail_yearlyResponse();
