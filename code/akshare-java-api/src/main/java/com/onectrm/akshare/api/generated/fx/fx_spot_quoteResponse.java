...
* 限量: 单次返回实时行情数据
*/
public class fx_spot_quoteResponse extends AkShareRequestAndResponse {
    public fx_spot_quoteResponse(){
        setInterfaceName("fx_spot_quote");
    }

    public static fx_spot_quoteResponse of(
    ...
    fx_spot_quoteResponse t = new fx_spot_quoteResponse();
