    ...
    */
    public class stock_board_industry_hist_emResponse extends AkShareRequestAndResponse {
    public stock_board_industry_hist_emResponse(){
    setInterfaceName("stock_board_industry_hist_em");
    }

    public static stock_board_industry_hist_emResponse of(
    ...
    <String
    , String>... others){
    stock_board_industry_hist_emResponse t = new stock_board_industry_hist_emResponse();
