    ...
    */
    public class stock_yjbb_emRequest extends AkShareRequestAndResponse {
    public stock_yjbb_emRequest(){
    setInterfaceName("stock_yjbb_em");
    }

    public static stock_yjbb_emRequest of(
    ...
    <String
    , String>... others){
    stock_yjbb_emRequest t = new stock_yjbb_emRequest();
