...
* 限量: 单次返回所有历史数据
*/
public class macro_swiss_svmeResponse extends AkShareRequestAndResponse {
    public macro_swiss_svmeResponse(){
        setInterfaceName("macro_swiss_svme");
    }

    public static macro_swiss_svmeResponse of(
    ...
    macro_swiss_svmeResponse t = new macro_swiss_svmeResponse();
