...
* 限量: 单次返回所有昨日涨停股池数据
*/
public class stock_zt_pool_previous_emRequest extends AkShareRequestAndResponse {
    public stock_zt_pool_previous_emRequest(){
        setInterfaceName("stock_zt_pool_previous_em");
    }

    public static stock_zt_pool_previous_emRequest of(
    ...
    stock_zt_pool_previous_emRequest t = new stock_zt_pool_previous_emRequest();
