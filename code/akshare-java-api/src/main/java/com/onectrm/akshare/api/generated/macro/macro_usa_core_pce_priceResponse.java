    ...
    * 限量: 单次返回某一个所有历史数据
    */
    public class macro_usa_core_pce_priceResponse extends AkShareRequestAndResponse {
    public macro_usa_core_pce_priceResponse(){
    setInterfaceName("macro_usa_core_pce_price");
    }

    public static macro_usa_core_pce_priceResponse of(
    ...
    <String
    , String>... others){
    macro_usa_core_pce_priceResponse t = new macro_usa_core_pce_priceResponse();
