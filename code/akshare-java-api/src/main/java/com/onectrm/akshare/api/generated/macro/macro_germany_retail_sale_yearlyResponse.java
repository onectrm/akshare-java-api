...
* 限量: 单次返回所有历史数据
*/
public class macro_germany_retail_sale_yearlyResponse extends AkShareRequestAndResponse {
    public macro_germany_retail_sale_yearlyResponse(){
        setInterfaceName("macro_germany_retail_sale_yearly");
    }

    public static macro_germany_retail_sale_yearlyResponse of(
    ...
    macro_germany_retail_sale_yearlyResponse t = new macro_germany_retail_sale_yearlyResponse();
