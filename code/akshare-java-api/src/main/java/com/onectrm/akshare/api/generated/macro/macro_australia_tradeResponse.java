    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_australia_tradeResponse extends AkShareRequestAndResponse {
    public macro_australia_tradeResponse(){
    setInterfaceName("macro_australia_trade");
    }

    public static macro_australia_tradeResponse of(
    ...
    <String
    , String>... others){
    macro_australia_tradeResponse t = new macro_australia_tradeResponse();
