...
* 限量: 单次返回所有历史数据
*/
public class macro_uk_gdp_yearlyResponse extends AkShareRequestAndResponse {
    public macro_uk_gdp_yearlyResponse(){
        setInterfaceName("macro_uk_gdp_yearly");
    }

    public static macro_uk_gdp_yearlyResponse of(
    ...
    macro_uk_gdp_yearlyResponse t = new macro_uk_gdp_yearlyResponse();
