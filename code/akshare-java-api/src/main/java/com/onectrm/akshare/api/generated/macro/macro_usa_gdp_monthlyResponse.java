...
* 限量: 单次返回某一个所有历史数据
*/
public class macro_usa_gdp_monthlyResponse extends AkShareRequestAndResponse {
    public macro_usa_gdp_monthlyResponse(){
        setInterfaceName("macro_usa_gdp_monthly");
    }

    public static macro_usa_gdp_monthlyResponse of(
    ...
    macro_usa_gdp_monthlyResponse t = new macro_usa_gdp_monthlyResponse();
