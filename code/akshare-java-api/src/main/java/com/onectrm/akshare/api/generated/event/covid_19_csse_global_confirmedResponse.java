    ...
    * 限量: 单次返回所有历史数据，每日更新
    */
    public class covid_19_csse_global_confirmedResponse extends AkShareRequestAndResponse {
    public covid_19_csse_global_confirmedResponse(){
    setInterfaceName("covid_19_csse_global_confirmed");
    }

    public static covid_19_csse_global_confirmedResponse of(
    ...
    <String
    , String>... others){
    covid_19_csse_global_confirmedResponse t = new covid_19_csse_global_confirmedResponse();
