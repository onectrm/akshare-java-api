    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_construction_indexResponse extends AkShareRequestAndResponse {
    public macro_china_construction_indexResponse(){
    setInterfaceName("macro_china_construction_index");
    }

    public static macro_china_construction_indexResponse of(
    ...
    <String
    , String>... others){
    macro_china_construction_indexResponse t = new macro_china_construction_indexResponse();
