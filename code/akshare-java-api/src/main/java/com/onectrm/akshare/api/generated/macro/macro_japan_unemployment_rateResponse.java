    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_japan_unemployment_rateResponse extends AkShareRequestAndResponse {
    public macro_japan_unemployment_rateResponse(){
    setInterfaceName("macro_japan_unemployment_rate");
    }

    public static macro_japan_unemployment_rateResponse of(
    ...
    <String
    , String>... others){
    macro_japan_unemployment_rateResponse t = new macro_japan_unemployment_rateResponse();
