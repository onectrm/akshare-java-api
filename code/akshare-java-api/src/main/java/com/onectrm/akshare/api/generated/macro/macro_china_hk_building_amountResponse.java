    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_china_hk_building_amountResponse extends AkShareRequestAndResponse {
    public macro_china_hk_building_amountResponse(){
    setInterfaceName("macro_china_hk_building_amount");
    }

    public static macro_china_hk_building_amountResponse of(
    ...
    <String
    , String>... others){
    macro_china_hk_building_amountResponse t = new macro_china_hk_building_amountResponse();
