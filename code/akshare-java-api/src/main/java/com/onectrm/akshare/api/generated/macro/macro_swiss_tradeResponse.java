    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_swiss_tradeResponse extends AkShareRequestAndResponse {
    public macro_swiss_tradeResponse(){
    setInterfaceName("macro_swiss_trade");
    }

    public static macro_swiss_tradeResponse of(
    ...
    <String
    , String>... others){
    macro_swiss_tradeResponse t = new macro_swiss_tradeResponse();
