...
* 限量: 单次返回所有历史数据
*/
public class macro_canada_gdp_monthlyResponse extends AkShareRequestAndResponse {
    public macro_canada_gdp_monthlyResponse(){
        setInterfaceName("macro_canada_gdp_monthly");
    }

    public static macro_canada_gdp_monthlyResponse of(
    ...
    macro_canada_gdp_monthlyResponse t = new macro_canada_gdp_monthlyResponse();
