    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_euro_employment_change_qoqResponse extends AkShareRequestAndResponse {
    public macro_euro_employment_change_qoqResponse(){
    setInterfaceName("macro_euro_employment_change_qoq");
    }

    public static macro_euro_employment_change_qoqResponse of(
    ...
    <String
    , String>... others){
    macro_euro_employment_change_qoqResponse t = new macro_euro_employment_change_qoqResponse();
