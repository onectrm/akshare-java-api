    ...
    * 限量: 单次返回所有历史数据，每日更新
    */
    public class covid_19_csse_global_recoveredResponse extends AkShareRequestAndResponse {
    public covid_19_csse_global_recoveredResponse(){
    setInterfaceName("covid_19_csse_global_recovered");
    }

    public static covid_19_csse_global_recoveredResponse of(
    ...
    <String
    , String>... others){
    covid_19_csse_global_recoveredResponse t = new covid_19_csse_global_recoveredResponse();
