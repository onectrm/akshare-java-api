    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_australia_bank_rateResponse extends AkShareRequestAndResponse {
    public macro_australia_bank_rateResponse(){
    setInterfaceName("macro_australia_bank_rate");
    }

    public static macro_australia_bank_rateResponse of(
    ...
    <String
    , String>... others){
    macro_australia_bank_rateResponse t = new macro_australia_bank_rateResponse();
