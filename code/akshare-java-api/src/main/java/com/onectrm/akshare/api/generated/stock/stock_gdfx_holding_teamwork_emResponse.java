...
* 限量: 单次返回所有数据
*/
public class stock_gdfx_holding_teamwork_emResponse extends AkShareRequestAndResponse {
    public stock_gdfx_holding_teamwork_emResponse(){
        setInterfaceName("stock_gdfx_holding_teamwork_em");
    }

    public static stock_gdfx_holding_teamwork_emResponse of(
    ...
    stock_gdfx_holding_teamwork_emResponse t = new stock_gdfx_holding_teamwork_emResponse();
