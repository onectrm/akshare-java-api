    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_canada_core_cpi_monthlyResponse extends AkShareRequestAndResponse {
    public macro_canada_core_cpi_monthlyResponse(){
    setInterfaceName("macro_canada_core_cpi_monthly");
    }

    public static macro_canada_core_cpi_monthlyResponse of(
    ...
    <String
    , String>... others){
    macro_canada_core_cpi_monthlyResponse t = new macro_canada_core_cpi_monthlyResponse();
