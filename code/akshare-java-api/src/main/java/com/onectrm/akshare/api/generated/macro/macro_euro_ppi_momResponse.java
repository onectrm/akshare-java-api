    ...
    * 限量: 单次返回所有历史数据
    */
    public class macro_euro_ppi_momResponse extends AkShareRequestAndResponse {
    public macro_euro_ppi_momResponse(){
    setInterfaceName("macro_euro_ppi_mom");
    }

    public static macro_euro_ppi_momResponse of(
    ...
    <String
    , String>... others){
    macro_euro_ppi_momResponse t = new macro_euro_ppi_momResponse();
