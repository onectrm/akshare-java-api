...
* 限量: 单次返回所有历史数据
*/
public class macro_bank_russia_interest_rateResponse extends AkShareRequestAndResponse {
    public macro_bank_russia_interest_rateResponse(){
        setInterfaceName("macro_bank_russia_interest_rate");
    }

    public static macro_bank_russia_interest_rateResponse of(
    ...
    macro_bank_russia_interest_rateResponse t = new macro_bank_russia_interest_rateResponse();
